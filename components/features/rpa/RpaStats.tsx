      ...
      <RpaCard variant="gold" className="p-8 md:p-12 relative group border-yellow-600/20 shadow-[0_0_80px_rgba(202,138,4,0.1)]">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 relative z-10">
          <div className="text-center md:text-left space-y-1">
            <p className="text-[9px] font-black uppercase text-yellow-600/60 tracking-[0.3em]">Mes points cumulés</p>
            <div className="flex items-baseline justify-center md:justify-start gap-3">
              <p className="text-5xl md:text-7xl font-black text-white font-mono tracking-tighter leading-none">
                {score.toLocaleString()}
              </p>
              <span className="text-lg font-black text-yellow-600 uppercase tracking-widest italic">Pts</span>
            </div>
          </div>
