      ...
      <section className="relative h-[90vh] flex flex-col justify-end p-6 overflow-hidden">
        ...
        <div className="relative z-10 space-y-4 animate-fade-in">
          ...
          <div className="pt-4 flex flex-col gap-3">
             <button 
                onClick={onPurchase}
                className="w-full bg-white text-black py-5 rounded-2xl font-black uppercase tracking-widest flex items-center justify-center gap-2 active:scale-95 transition-all shadow-[0_20px_40px_rgba(255,255,255,0.1)]"
             >
            ...
            {purchaseStep === 'view' && (
              <div className="space-y-8">
                <div className="flex flex-col sm:flex-row justify-between items-center gap-6">
                  <div className="text-center sm:text-left">
                    ...
                    <div className="flex items-baseline justify-center sm:justify-start whitespace-nowrap">
                      <p className="text-4xl sm:text-5xl font-black text-white font-mono tracking-tighter">{product.price.toLocaleString()}</p>
                      <span className="text-sm sm:text-lg text-yellow-500 font-black ml-2">CFA</span>
                    </div>
                  </div>
                  <div className="flex flex-col items-center sm:items-end gap-1">
                    <p className="text-sm text-neutral-600 line-through font-bold">{(product.price * 1.5).toLocaleString()} F</p>
                ...
                <div className="space-y-6">
                  <button 
                    onClick={onPurchase}
                    className="w-full bg-yellow-500 text-black py-6 rounded-2xl font-black uppercase tracking-widest shadow-[0_10px_30px_rgba(234,179,8,0.3)] active:scale-95 transition-all text-sm"
                  >
